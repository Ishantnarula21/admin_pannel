...
<body>
	...
	<aside>
		...
		<div class="col-md-10 main-section">
			<section>
				...
				<p class="bordered text-center" style="padding:3px"><a href="#" style="text-decoration:underline; color:blue; font-size:12px">Click here</a>
						to create
						<a href="#" style="text-decoration:underline; color:blue; font-size:12px">New product</a></p>
		<form>				
			<table class="table1">
		...
		<p style="padding-top:20px">product 1 of 2, showing 10 records out  of 13 total, starting on record 1, ending on 10</p>
		<table class="table2">
			<thead>
				<tr>
					<th>Id</th>
			...
			<tbody>
				<?php
					if(!empty($_REQUEST['searchbtn']))
					{
						...
						$query="select * from product where pname like '%$sname%'";
					}
					else{
					...
					while($row=mysqli_fetch_assoc($result))
					{
						?>
							<tr>
								...
								<td><img style="width:100px;" src="upload/<?php echo $row['pimage'] ?>" alt="no image found"/></td>
								<td><a href="productadd.php?eid=<?php echo $row['id'] ?>"><img src="images/edit.jpg" alt="no image found" class="edit"/></a></td>
